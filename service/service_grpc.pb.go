...
func (c *kVRPCClient) Del(ctx context.Context, in *DelRequest, opts ...grpc.CallOption) (*DelResponse, error) {
	out := new(DelResponse)
...
func (UnimplementedKVRPCServer) Del(context.Context, *DelRequest) (*DelResponse, error) {
